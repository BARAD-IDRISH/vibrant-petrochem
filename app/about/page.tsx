  ...
  return (
    <main className="min-h-screen bg-white text-[#0F172A] pt-28 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <div className="mt-16 bg-[#F8FAFC] text-[#0F172A] p-10 rounded-2xl text-center space-y-6 border border-[#E2E8F0] shadow-sm">
          <span className="text-xs font-bold uppercase tracking-widest text-[#2563EB]">
            Strategic Partnerships
          </span>
          <h3 className="text-2xl font-bold font-display text-[#0F172A]">
            Ready to Partner with Vibrant Petrochem?
          </h3>
