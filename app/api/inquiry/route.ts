...
export async function POST(request: Request) {
  try {
    ...
    // SMTP Configuration for A2 Hosting / Custom Mail Server
    ...
    if (pass) {
      ...
      console.log('[SMTP NOTICE] SMTP_PASS environment variable is not configured. Inquiry recorded in server logs.');
    }
