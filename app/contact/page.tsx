    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
      ...
      <div className="lg:col-span-7">
        <div className="bg-white p-8 sm:p-10 rounded-3xl border border-slate-200 shadow-xl">
          <h2 className="text-2xl font-bold font-display text-slate-900 mb-2">Submit Formal Trade Inquiry</h2>
          ...
          {submitSuccess ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs text-slate-900 focus:outline-none focus:border-brand-red-vibrant"
                  />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-800 mb-1">Telephone / WhatsApp *</label>
                  <input
                    type="text"
                    required
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-slate-800 mb-1">Product Line *</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-800 mb-1">Volume (MT or Barrels) *</label>
                  <input
                    type="text"
                    required
              ...
              <div>
                <label className="block text-xs font-bold text-slate-800 mb-1">Destination Discharge Port *</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-slate-800 mb-1">Specification Notes / Message</label>
                <textarea
                  rows={4}
              ...
              <button
                ...
                className="w-full bg-brand-red-vibrant hover:bg-brand-red-hover text-white text-xs font-bold py-3.5 rounded-xl transition-all shadow-lg flex items-center justify-center space-x-2"
              >
