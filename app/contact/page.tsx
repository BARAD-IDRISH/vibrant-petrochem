        ...
        <div className="bg-white p-4 rounded-2xl shadow-md border border-slate-200 space-y-3">
          <div className="flex items-center justify-between px-2 pt-1">
            ...
            <a
              ...
              className="text-[10px] font-semibold text-brand-red-vibrant bg-red-50 hover:bg-red-100 px-2.5 py-0.5 rounded-full transition-colors flex items-center space-x-1"
            >
              <span>Open in Google Maps ↗</span>
            </a>
          </div>
          <div className="w-full h-56 rounded-xl overflow-hidden border border-slate-200 shadow-inner bg-slate-100 relative">
            <iframe
