...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://images.unsplash.com https://lh3.googleusercontent.com https://*.tile.openstreetmap.org",
      "connect-src 'self' https://*.tile.openstreetmap.org",
      "frame-src 'self' https://www.openstreetmap.org https://*.openstreetmap.org https://maps.google.com https://www.google.com",
