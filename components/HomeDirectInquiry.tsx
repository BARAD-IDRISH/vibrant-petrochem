    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 pt-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-[#F8FAFC] text-[#0F172A] p-6 rounded-3xl shadow-sm space-y-3 border border-[#E2E8F0]">
            <div className="flex items-center space-x-2 text-xs font-bold text-[#2563EB] uppercase tracking-wider">
